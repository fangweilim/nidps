...
<html>
    ...
    <body>
        ...
        <form class="bf" action="bf.php" method="GET">
            <input type="text" name="md5" placeholder="Enter md5" size="40" value="<?php
            if(!isset($_GET['submit'])){
                echo "";
            }else{
                echo $_GET['md5'];
        ...
        <div class="button" style="text-align:center;">
            <a href="bf.php"><button type="button" name="button" class="button1" >Reset</button></a>
